...
public class TweetTwoFragment extends Fragment{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    final User user = twitter.showUser("VckAds");
                    ...
                    statuses = twitter.getUserTimeline("VckAds", paging);
                    final TweetsTwoArrayAdapter tweetsAdapter = new TweetsTwoArrayAdapter(
    ...
    private class TweetsTwoArrayAdapter extends ArrayAdapter<List> {

        public TweetsTwoArrayAdapter(Context context, int resource, List objects) {
